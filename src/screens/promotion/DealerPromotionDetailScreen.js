...
const DealerPromotionDetailScreen = ({ navigation, route }) => {
  ...
  const handleEdit = () => {
    navigation.navigate('EditDealerPromotion', { promotion });
  };
  ...
  const deletePromotion = async () => {
    try {
      ...
      // await dealerPromotionService.deletePromotion(promotion.id);
          ...
          <View style={styles.targetCard}>
            <View style={styles.targetItem}>
              ...
              <View style={styles.targetInfo}>
                ...
                <Text style={styles.targetValue}>{promotion.targetCustomers}</Text>
              </View>
            </View>
          </View>
        </View>
...
export default DealerPromotionDetailScreen;
