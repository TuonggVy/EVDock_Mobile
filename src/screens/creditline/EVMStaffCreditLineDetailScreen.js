...
const EVMStaffCreditLineDetailScreen = ({ navigation, route }) => {
  ...
  const handleDelete = () => {
    ...
    const agencyName = creditLine.agency?.name || `Agency #${creditLine.agencyId}`;
    setAlertConfig({
...
export default EVMStaffCreditLineDetailScreen;
