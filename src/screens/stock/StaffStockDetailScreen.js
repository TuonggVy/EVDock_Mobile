...
const StaffStockDetailScreen = ({ navigation, route }) => {
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.infoSection}>
          ...
          {motorbike.description ? <Text style={styles.stockDescription}>{motorbike.description}</Text> : null}
        </View>
        ...
        {promotions.length > 0 && (
          <View style={styles.promotionsSection}>
            ...
            {promotions.map((promoItem, index) => {
              ...
              const valueDisplay = promo.valueType === 'PERCENT' ? `${promo.value}%` : formatPrice(promo.value);
              ...
              return (
                <View key={promoItem.stockPromotionId || index} style={styles.promoCard}>
                  ...
                  {promo.description ? <Text style={styles.promoDescription}>{promo.description}</Text> : null}
...
export default StaffStockDetailScreen;
